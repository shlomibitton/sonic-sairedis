        ...
        _In_ sai_object_id_t portRid)
{
    ...
    // Not implemented, falling back to previous implementation
    else if(status == SAI_STATUS_NOT_IMPLEMENTED)
    {
        SWSS_LOG_INFO("SHLOMI updateSupportedPortCounters returned NOT IMPLEMENTED");
        uint64_t value;
    ...
    SWSS_LOG_INFO("SHLOMI updateSupportedPortCounters got the size but failed to get");
    if (status != SAI_STATUS_SUCCESS)
    {
